...
AWOnestepcheckoutPayment.prototype = {
    initialize: function(config) {
        ...
        this.paymentChangeTriggerEwayElementsIds = config.paymentChangeTriggerEwayElementsIds;
    ...
    initObservers: function() {
        ...
        if (typeof EwayPayment != 'undefined') {
            this.paymentChangeTriggerEwayElementsIds.each(function(elementId){
                var element = $(elementId);
                if (element) {
                    element.observe('change', me.savePayment.bind(me));
                }
            });
        }
    },
    ...
    savePayment: function() {
        ...
        if (typeof EwayPayment != 'undefined' && EwayPayment.isEwayRapidMethod(this.currentMethod)) {
